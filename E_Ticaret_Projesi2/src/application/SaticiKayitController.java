...
public class SaticiKayitController implements Initializable {
    ...
    @FXML
    private PasswordField sayici_kayit;
    ...
    void kaydolButton_click(ActionEvent event) {
    	try {
			...
			String sayicikayit = sayici_kayit.getText().trim();
			String sifre = sifre_pf.getText().trim();
			
			if(ad.isEmpty()||soyad.isEmpty()||email.isEmpty()||sayicikayit.isEmpty()||sifre.isEmpty()) {
			...
			String sorgu= "INSERT INTO saticilar (ad,soyad,email,sifre,satici_kod) VALUES (?,?,?,?,?)";
			ps=vt.baglan().prepareStatement(sorgu);
			ps.setString(1, ad);
			ps.setString(2, soyad);
			ps.setString(3, email);
			ps.setString(4, sifre);
			ps.setString(5, sayicikayit);
    ...
    @FXML
    void initialize() {
        assert ad_tf != null : "fx:id=\"ad_tf\" was not injected: check your FXML file 'SaticiKayit.fxml'.";
        assert email_tf != null : "fx:id=\"email_tf\" was not injected: check your FXML file 'SaticiKayit.fxml'.";
        assert kaydolButton != null : "fx:id=\"kaydolButton\" was not injected: check your FXML file 'SaticiKayit.fxml'.";
        assert oturumgit != null : "fx:id=\"oturumgit\" was not injected: check your FXML file 'SaticiKayit.fxml'.";
        assert sayici_kayit != null : "fx:id=\"sayici_kayit\" was not injected: check your FXML file 'SaticiKayit.fxml'.";
        assert shownPassword != null : "fx:id=\"shownPassword\" was not injected: check your FXML file 'SaticiKayit.fxml'.";
        assert sifre_pf != null : "fx:id=\"sifre_pf\" was not injected: check your FXML file 'SaticiKayit.fxml'.";
        assert soyad_tf != null : "fx:id=\"soyad_tf\" was not injected: check your FXML file 'SaticiKayit.fxml'.";
        assert toggleButton != null : "fx:id=\"toggleButton\" was not injected: check your FXML file 'SaticiKayit.fxml'.";
